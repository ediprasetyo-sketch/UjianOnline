...
@media(max-width:700px){body{font-size:16px}.wrap{margin:0 auto;padding:14px;max-width:100%}.card{padding:20px 16px;border-radius:16px}h1{font-size:26px;line-height:1.2}input,textarea,select,button{font-size:16px!important}}
@media(max-width:480px){.wrap{padding:10px}.card{padding:18px 14px;border-radius:14px}h1{font-size:23px}.link-help{font-size:13px}}
img{max-width:100%;height:auto}
@media (max-width:760px){body{font-size:16px!important;overflow-x:hidden}.wrap{width:100%;max-width:none;padding:14px!important}.card{padding:18px 14px!important;margin:12px 0!important;border-radius:14px!important}input,select,textarea,button{font-size:16px!important;max-width:100%}input,select,textarea{min-height:44px}button,.btn{min-height:44px;touch-action:manipulation}table{max-width:100%}}
@media (max-width:480px){.wrap{padding:10px!important}.card{padding:16px 12px!important}}
